...
New-ADOrganizationalUnit -Name ST_Computers -Path "dc=ad,DC=basande5,DC=lan" -Description "ST Computers"
 New-ADOrganizationalUnit -Name Workstations -Path "OU=BS_Computers,dc=ad,DC=basande5,DC=lan"
  ...
  New-ADOrganizationalUnit -Name HR -Path "OU=Workstations,OU=BS_Computers,dc=ad,DC=basande5,DC=lan"
  New-ADOrganizationalUnit -Name Sales -Path "OU=Workstations,OU=BS_Computers,dc=ad,DC=basande5,DC=lan"
  New-ADOrganizationalUnit -Name Legal -Path "OU=Workstations,OU=BS_Computers,dc=ad,DC=basande5,DC=lan"
  New-ADOrganizationalUnit -Name IT -Path "OU=Workstations,OU=BS_Computers,dc=ad,DC=basande5,DC=lan"
...
New-ADGroup -GroupCategory Security -GroupScope Global -Name President -Path "OU=BS_Groups,dc=ad,DC=basande5,DC=lan"
New-ADGroup -GroupCategory Security -GroupScope Global -Name Finance -Path "OU=BS_Groups,dc=ad,DC=basande5,DC=lan"
New-ADGroup -GroupCategory Security -GroupScope Global -Name HR -Path "OU=BS_Groups,dc=ad,DC=basande5,DC=lan"
New-ADGroup -GroupCategory Security -GroupScope Global -Name Sales -Path "OU=BS_Groups,dc=ad,DC=basande5,DC=lan"
New-ADGroup -GroupCategory Security -GroupScope Global -Name Legal -Path "OU=BS_Groups,dc=ad,DC=basande5,DC=lan"
New-ADGroup -GroupCategory Security -GroupScope Global -Name IT -Path "OU=BS_Groups,dc=ad,DC=basande5,DC=lan"
# Create a Leadership group for the President and VPs to access restricted a file share
New-ADGroup -GroupCategory Security -GroupScope Global -Name Leadership -Path "OU=BS_Groups,dc=ad,DC=basande5,DC=lan"
